...
import tattooFooter from "../core/assets/tattooFooter.svg";
...
const FooterSection = ({ id, color }: NextFooterProps) => {
  return (
    <footer>
      <Box bg={color} pt={12} pb={12} id={id}>
            ...
            <Container maxW='2xl'>
              <Box>
                ...
                <HStack spacing={6} pt={4} pb={10}>
                  ...
                  <Link
                    href={`https://api.whatsapp.com/send?phone=${numberPhone}&text=Ol%C3%A1,%20NeXTIME!%0AGostaria%20de%20solicitar%20um%20orçamento.`}
                  >
                    <a target='_blank' rel='noreferrer'>
                      <Icon
                        color='white'
